...
window.TTC_CONTENT = {
  ...
  emergency: {
    // Personal numbers stay in the Google-gated contacts sheet. Only the public office line goes here.
    office: { label: "Call the Office", tel: "4357521884", display: "(435) 752-1884" },
    contacts: {
    ...
    poison: { label: "Pesticide Emergency (NPIC)", tel: "18008587378", display: "1-800-858-7378" }
  },

  sections: [
    {
      id: "safety", title: "Safety", roles: ["crew"],
      tiles: [
    ...
    {
      id: "handbook", title: "Policies and Procedures", roles: ["crew"],
      tiles: [
        { id: "handbook-2020", label: "Policies and Procedures Book (2020)", desc: "The current book, as written. Changes collect in Notes until the next edition.", href: "https://drive.google.com/file/d/1bXUEv6epzaC0IyIEe7Tiy2muqugoqmsw/view", kind: "pdf", search: "handbook rules uniform training schedule compensation" },
        { id: "handbook-notes", label: "Notes and Proposed Changes", desc: "David's notes on the printed copy, and anything new we agree to change", href: "https://drive.google.com/drive/folders/1CKewd5W-8EAXpIigN65CfiAEC-oc2GJc", kind: "link", search: "updates revisions" },
    ...
    {
      id: "equipment", title: "Maintenance and Equipment", roles: ["crew"],
      tiles: [
    ...
    {
      id: "forms", title: "Forms and Requests", roles: ["crew"],
      tiles: [
    ...
    {
      id: "reviews", title: "Reviews and Recognition", roles: ["crew"],
      tiles: [
    ...
    {
      id: "customer-tools", title: "Customer Tools (share these)", roles: ["crew"],
      tiles: [
        ...
        { id: "door-hanger", label: "PHC Door Hanger", desc: "The plant health care leave-behind, as printed", href: "https://myersmail9-afk.github.io/ttc-tools/door-hanger/", kind: "app", search: "phc spray leave behind" },
        { id: "website", label: "totaltreecareutah.com", desc: "The company website", href: "https://www.totaltreecareutah.com/", kind: "link" }
      ]
    },

    {
      id: "office", title: "Office", roles: ["office"],
      tiles: [
    ...
    {
      id: "hiring", title: "Office: Hiring Paperwork", roles: ["office"],
      tiles: [
        { id: "i9", label: "Form I-9", desc: "Employment eligibility", href: "https://drive.google.com/file/d/1IIeQ1aRXCUvZMZEiMPaKo4PBv9L90LuJ/view", kind: "pdf" },
        { id: "w4", label: "Form W-4", desc: "Federal withholding", href: "https://drive.google.com/file/d/12U4tgBhKB5dzEHxGQQz4bpNLVp6q14Hi/view", kind: "pdf" },
        { id: "direct-deposit", label: "Direct Deposit Authorization", desc: "", href: "https://drive.google.com/file/d/1_PJpv67b-vAPke4sf9Th9eyo5COh-NOe/view", kind: "pdf" },
        { id: "nda", label: "Non-Compete and Non-Disclosure", desc: "Signed at hire", href: "https://drive.google.com/file/d/1SxGoCl13imFcI99ea-KA6W5P0mox2TO8/view", kind: "pdf" },
        { id: "pp-signature", label: "Policies and Procedures Signature Page", desc: "Signed after reading the book", href: "https://drive.google.com/file/d/12QJmejUW2PsTIojJM_hWKGBXZqXuHTSd/view", kind: "pdf" }
      ]
    }
  ]
};
